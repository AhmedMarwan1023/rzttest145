...
[ انشئ روم welcome لتفعيل خاصية الترحيب ]
**
  `
,`
...
if (message.content.startsWith(adminprefix + 'setT')) {
  client.user.setGame(argresult, "https://www.twitch.tv/ahmed_dz11");
...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=513005371825192974&permissions=8&scope=bot`)
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/qCyBGPv**")
